...
titles = ['DbTSW', "NTSW", "TSW-uni", "NonlinearTSW"]
...
n_projs = [int(args.L / args.n_lines), int(args.L / args.n_lines), int(args.L / args.n_lines), int(args.L / args.n_lines), int(args.L / args.n_lines), args.L, args.L, args.L, args.L]
